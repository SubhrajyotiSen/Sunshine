...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String PATH_WITH_FEATURE = "/weather";
    ...
    private void updateWear(){
        ...
        if (cursor.moveToFirst()) {
            ...
            config.putInt(String.valueOf(INDEX_WEATHER_ID), weatherId);
            config.putDouble(String.valueOf(INDEX_MAX_TEMP), high);
            config.putDouble(String.valueOf(INDEX_MIN_TEMP), low);
